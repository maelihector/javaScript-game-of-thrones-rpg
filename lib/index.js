...
var allRolesdDiv = document.getElementById('all-roles');
var historyDiv = document.getElementById('history-div');
var opponentDiv = document.getElementById('opponent');
var undefeatedCardsDiv = document.getElementById('undefeated');
var gameMessageDiv = document.getElementById('game-message');
var attackBtnDiv = document.getElementById('attack-button');
...
var numAttacks = 0;
var playerStartingAttackPower = void 0;
var playerStartingHealthPoints = void 0;
var updatedPlayerAttackPower = void 0;
var updatedPlayerHealthPoints = void 0;
var opponentStartingHealthPoints = void 0;
var updatedOpponentHealthPoints = void 0;
var currentOpponentCounterAttackPower = void 0;
var lastNumAttacks = void 0;
var lastOpponent = void 0;
...
function renderRoleCards(role, area) {
  ...
  if (area === 'undefeated') {
    ...
    var battlegroundDiv = document.getElementById('battle-ground');
  ...
  var htmlArea = document.getElementById(area);
...
function pickOpponent(value) {
  ...
  if (!opponent) {
    ...
    var opponentIndex = enemies.indexOf(opponent);
...
function opponentExtinction() {
  ...
  var numAttacksInBattle = Math.abs(lastNumAttacks - numAttacks);
  ...
  var defeatedEnemies = document.getElementById('defeated');
  var numberDefeatedEnemies = defeatedEnemies.children.length;
...
function gameMessage() {
  ...
  if (!player) {
    var pickPlayerMessage = 'Choose Your Player';
    ...
    var pickOpponentMesage = 'Choose Your Opponent';
    gameMessageDiv.append(pickOpponentMesage);
    // Else player has won
  } else {
    var playerWinsMessage = "You are the Supreme Ruler of the Seven Kingdoms!";
...
function showHPsChangeOnCards() {
  ...
  var opponentCard = document.getElementById(opponent);
  // Last child of role card is where health points are located
  var opponentH4 = opponentCard.lastChild;
  var playerH4 = playerCard.lastChild;
...
function toggleElement(elementToToggle, eventElement, stringWhenClosed, stringWhenOpened) {
  ...
  var toggledElement = document.getElementById(elementToToggle);
  // Grab element that triggers each toggle
  var triggerElement = document.getElementById(eventElement);
  // Empty text inside trigger element
  triggerElement.innerText = '';
  // Grab display style of element to toggle
  var currentDisplay = toggledElement.getAttribute('style');
